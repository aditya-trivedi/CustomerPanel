...
<html>
 <head>
  <title> iFurnish | Add Supervisor </title>
  <meta charset="utf-8">
...
<style >
 ...
 <nav>
    <div class="nav-wrapper blue z-depth-0">
      <a href="#" class="brand-logo hide-on-med-and-down" >iFurnish | Add Supervisor</a>
 ...
 <div class="row  margin_up">
  <div class="col  card l4 center-align push-l4 push-s1 push-m3 s10 m6 ">
    <div class="row "><h4 class="center-align">Add Supervisor</h4></div>
    <div class="center-align">
    <form action="http://www.yourwebsite.com/panel/add_supervisor.php" method="post">
      <div class="center-align">
      <div class="row">
...
<div class="center-align"><h4> Currrent Supervisors</h4></div>
